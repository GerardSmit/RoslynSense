...
internal static class ResourceKeySearch
{
    ...
    private const string Wildcard = MemberSignature.Wildcard;
    ...
    private static bool DeclaredBy(INamedTypeSymbol type, string name) =>
        MemberSignature.DeclaredBy(type, name);
    ...
    /// <summary>See <see cref="MemberSignature.DeclarationName"/>: the spelling a configured
    /// containing type is compared against.</summary>
    private static readonly SymbolDisplayFormat s_declarationName = MemberSignature.DeclarationName;
