...
public class FileOutlineFormatterTests
{
    [Fact]
    public async Task WhenEmptyPathProvidedThenReturnsError()
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: "", fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: "Z:/nonexistent/file.cs", fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.CalculatorFile, fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.ResultFile, fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.OutlineShowcaseFile, fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.DefaultAspxFile, fmt: new MarkdownFormatter(), handlers: TestHandlers.Outline);
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.HeaderControlFile, fmt: new MarkdownFormatter(), handlers: TestHandlers.Outline);
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.SiteMasterFile, fmt: new MarkdownFormatter(), handlers: TestHandlers.Outline);
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.ServicesFile, fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.TextUtilitiesFile, fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.BrokenSyntaxFile, fmt: new MarkdownFormatter());
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.DataServiceFile, fmt: new MarkdownFormatter(), handlers: TestHandlers.Outline);
    ...
    {
        var result = await FileOutlineFormatter.GetFileOutline(filePath: FixturePaths.ImageHandlerFile, fmt: new MarkdownFormatter(), handlers: TestHandlers.Outline);
